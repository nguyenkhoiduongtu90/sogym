// Service Worker cho Sổ Gym — A7_v1 (Cross-origin GET bypass cache).
// Dựa trên SW_A4_5_v1.js (KHÔNG bị sửa, giữ nguyên cho các bản đã confirm OK trước đó) — chỉ thêm
// 1 thay đổi: các request GET tới nguồn KHÁC GỐC (vd Google Sheets API, Google Identity script)
// không còn bị cache-first nữa, luôn đi thẳng ra mạng.
